...
* [Hacefile.yml Format](hacefile-format.md)
...
* [Basic Build System](examples/basic-build.md)
* [Crystal Project](examples/crystal-project.md)
* [Documentation Generation](examples/documentation.md)
* [Testing Workflow](examples/testing.md)
